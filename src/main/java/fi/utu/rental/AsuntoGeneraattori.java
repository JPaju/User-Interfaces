...
public class AsuntoGeneraattori {
    ...
    public static Asunto luo() {
        Asunto a = new Asunto();
        a.setKuvaFile("house" + (1+new Random().nextInt(6)) + ".svg");
        ...
        a.setRakennusyear(1850+new Random().nextInt(170));
        a.setNeliömäärä(8+3*new Random().nextInt(30));
        a.setVuokra((int)(a.getNeliömäärä()*(7f+(a.getRakennusyear()-1850)/20f+new Random().nextDouble()*9)));
        ...
        a.setSähkömail(n6 + new Random().nextInt(10000) + "@" + n7 + "mail.com");
        a.setKohteenDescription(new String[] { "Hyvä asunto keskeisellä paikalla kaikkien palveluiden äärellä."});
        return a;
    }
